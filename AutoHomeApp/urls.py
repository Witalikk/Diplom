...
urlpatterns = [
    ...
    path('allUsers', UserAllView.as_view()),
    ...
    # path('sms/<int:pk>', UpdateSMSListView.as_view()),
    path('sms/new/', SMSCreateView.as_view()),
    path('room/destroy/<int:pk>', RoomDestroyView.as_view()),
    path('sms/destroy/<int:pk>', SmsDestroyView.as_view()),
    path('user/destroy/<int:pk>', UserDestroyView.as_view()),
]
