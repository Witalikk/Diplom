<template>
  ...
  <div class=" ml-24 container flex flex-row flex items-center justify-center ">
    <div class="py-8">
      <h2 class="mb-4 uppercase tracking-wide text-2xl text-center">Аккаунт</h2>
      <form @submit.prevent="setUser">
        ...
        <div class="form-group mb-4">
          <button type="submit" class="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-green-800 hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">Изменить</button>
        </div>
      </form>
    </div>
  </div>
